...
public class DataRoomEntrepreneurSharingTest extends ApplicationKeywords
{
	...
	public DataRoomEntrepreneurSharingTest(BaseClass obj) 
	{
		super(obj);
		this.obj = obj;
	}
	...
	public void mainTest() 
	{
		try
		{
			...
			String documentEditedPermission = retrieve("documentEditedPermission");
			...
			/***********************Adding New Entreprenuer Individual Contact*******************************/
			
			testStepPassed("");
			testStepPassed("Adding New Entreprenuer Individual Contact");
			testStepPassed("**************************************************");
			...
			/***********************Verify Data Room is not displayed for new Entrepreneur user*******************************/

			testStepPassed("");
			testStepPassed("Verify Data Room is not displayed for new Entrepreneur user");
			testStepPassed("***********************************************************");
			...
			/***********************Share Data Room  to Newly registered Entrepreneur User*******************************/			

			testStepPassed("");
			testStepPassed("Share Data Room  to Newly registered Entrepreneur User");
			testStepPassed("***********************************************************");
			...
			/***********************Verify Data Room with File is displayed for new Entrepreneur User*******************************/

			testStepPassed("");
			testStepPassed("Verify Data Room with File is displayed for new Entrepreneur User");
			testStepPassed("*************************************************************************");
			...
			/***********************Restrict File in Data Room to newly registered Entrepreneur User*******************************/			

			testStepPassed("");
			testStepPassed("Restrict File in Data Room to newly registered Entrepreneur User");
			testStepPassed("*************************************************************************");
			...
			companyProfilePage.Change_DataRoomPage_CompanyProfileSection_EditFile_Restrict_Document_Permission(documentEditedPermission);
			...
			/***********************Verify Data Room is displayed and File is Restricted and not Displayed for New Entrepreneur User*******************************/

			testStepPassed("");
			testStepPassed("Verify Data Room is displayed and File is Restricted and not Displayed for New Entrepreneur User");
			testStepPassed("********************************************************************************************************************");
