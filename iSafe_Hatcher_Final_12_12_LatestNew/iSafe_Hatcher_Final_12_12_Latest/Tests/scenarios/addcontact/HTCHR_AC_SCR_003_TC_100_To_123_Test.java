...
public class HTCHR_AC_SCR_003_TC_100_To_123_Test extends ApplicationKeywords
{
	BaseClass obj;
	...
	public HTCHR_AC_SCR_003_TC_100_To_123_Test(BaseClass obj) 
	{
		super(obj);
		this.obj = obj;
	}
	...
	public void mainTest() 
	{
		try
		{
			...
			/***********************Adding New Entreprenuer Contact New Organization Valid Error Message*******************************/
			...
			popupDialogWindows.enter_Phone_AddOrganization_CreateContact_ModalDialog_Window(newContactOrganizationPhone);
			popupDialogWindows.enter_LinkedIn_AddOrganization_CreateContact_ModalDialog_Window(newContactOrganizationLinkedIn);
			popupDialogWindows.enter_Description_AddOrganization_CreateContact_ModalDialog_Window(newContactOrganizationDescription);
			popupDialogWindows.select_EmploymentStatus_AddOrganization_CreateContact_ModalDialog_Window(newContactOrganizationEmploymentStatus);
			popupDialogWindows.select_AddCompanyToPortfolio_AddOrganization_CreateContact_ModalDialog_Window(newContactOrganizationAddCompanyToPortfolio);
			
			popupDialogWindows.verify_AddListing_Button_Disabled_CreateContact_ModalDialog_Window_displayed();
			
			popupDialogWindows.click_Close_AddOrganization_CreateContact_ModalDialog_Window();
