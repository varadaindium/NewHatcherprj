...
public class AddContactInvestorAddOrganizationNewCompanyTest extends ApplicationKeywords
{
	...
	public AddContactInvestorAddOrganizationNewCompanyTest(BaseClass obj) 
	{
		super(obj);
		this.obj = obj;
	}
	...
	public void mainTest() 
	{
		try
		{
			...
			/***********************Adding New Investor Contact With New Organization*******************************/
		...
		{
			if(this.testFailure||this.obj.testFailure||mainPage.testFailure||loginPage.testFailure||popupDialogWindows.testFailure||userProfilePage.testFailure||emailReaderPage.testFailure||createPasswordPage.testFailure||companyProfilePage.testFailure||homePage.testFailure||settingsPage.testFailure||profileUpdateRegistrationPage.testFailure)
			{
