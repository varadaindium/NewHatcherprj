...
public class AddContactEntrepreneurIndividualTest extends ApplicationKeywords
{
	...
	public AddContactEntrepreneurIndividualTest(BaseClass obj) 
	{
		super(obj);
		this.obj = obj;
	}
	...
	public void mainTest() 
	{
		try
		{
			...
			String companyLegalName = companyLegalNameData+tempVariable3;
			...
			search_ValuesinSearchBar(companyLegalName);
			
			verify_Searched_Company_displayed_and_Open_CompanyProfilePage(companyLegalName);
