...
public class HTCHR_IS_SCR_005_TC_076_To_089_Test extends ApplicationKeywords
{
	...
	public HTCHR_IS_SCR_005_TC_076_To_089_Test(BaseClass obj) 
	{
		super(obj);
		this.obj = obj;
	}
	...
	public void mainTest() 
	{
		try
		{
			...
			/**********Checking Mail Id all registered in App and if exists deleting the profile with that Mail Id**********/
			//Pre-requiste for the test case --- END
			...
			//HTCHR_IS_SCR_002_TC_079-
			testStepInfo("HTCHR_IS_SCR_002_TC_079  -->"+"Verify \"City\"field allows spaces when combined with alphanumeric , special characters along with upper case & lower case characters");
			registrationCompanyPage.fillInvestorCompanyInformation(legalName, website, citySpecialCharacters ,country);			
			registrationCompanyPage.verifyNextButton_isenabled();
			//HTCHR_IS_SCR_002_TC_080 -  Deffered
			
				//HTCHR_IS_SCR_002_TC_081
			testStepInfo("HTCHR_IS_SCR_002_TC_081  -->"+"Verify on clicking tab on keyboard, cursor should navigate to next  fields  for each input");
			registrationCompanyPage.verify_Registration_Company_displayed();
			registrationCompanyPage.verify_PlaceHolder_After_Pressing_Tab();			
			refreshPage();
			
			//HTCHR_IS_SCR_002_TC_082 -
			testStepInfo("HTCHR_IS_SCR_002_TC_082  -->"+"Verify on clicking tab on keyboard, cursor should navigate to next  fields  for each input");
			registrationCompanyPage.verify_Registration_Company_displayed();
			registrationCompanyPage.verify_PlaceHolder_After_Pressing_Shift_And_Tab();
			
			testStepInfo("HTCHR_IS_SCR_002_TC_089  -->"+"Verify the user can navigate to next page (Investor details) on clicking \"Enter\" button by filling all mandatory and non mandatory fields");			
			refreshPage();			
			...
			registrationCompanyPage.click_Next_CompanyInformationUsingEnterKey();			
